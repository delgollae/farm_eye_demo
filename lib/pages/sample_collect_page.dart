...
import 'package:farm_eye_app/pages/login_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                onTap: (){
                  Navigator.pushNamed(context, router.ScreenRoutes.toHomePage);
                },
              ),
              ListTile(
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            const SizedBox(height: 100, child: HeaderWidget(height:100,showIcon:false,icon:Icons.house_rounded),),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Mr. Andy Mckelvey', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text('DAFM Farm', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    padding: EdgeInsets.all(10),
                    child: Column(
